                                ...
                                <div class="wrap-info" style="width: 100%; min-height: 1px; overflow: hidden; padding: 10px;">
                                    <table class="table tinfo" style="width: 80%;">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" class="form-control" placeholder="Họ và tên" name="name" value="" @if(Auth::guard('users')->user()) readonly @endif>
                                                <div class="error"></div>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" class="form-control" name="{{(Auth::guard('users')->user()) ? 'tv' : 'email' }}" value="" placeholder="Email" @if(Auth::guard('users')->user()) readonly @endif>
                                                <div class="error"></div>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text"  class="form-control" placeholder="Số điện thoại" name="phone" value="" @if(Auth::guard('users')->user()) readonly @endif>
                                                <div class="error"></div>
                                            </td>
                                        </tr>
                                        <tr>
