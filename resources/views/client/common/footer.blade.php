        ...
        <div class="container">
            <div class="col-xs-12 col-sm-12 col-md-6">
                <div class="col-xs-12 col-sm-6">
                    <a href="trang-chu">
                        <img src="{{asset('assets/images/smart-mobi2.png')}}" style="width: 100%;" class="img-fix f-logo" alt="smart-construction">
                    </a>
                    ...
                    <div class="f-contact">
                        ...
                        <ul class="list-unstyled">
                            <li class="clearfix">
                                ...
                                <span>72 Trần Đại Nghĩa , Hai Bà Trưng, Hà Nội</span>
                            </li>
                            <li class="clearfix">
                            ...
                            <li class="clearfix">
                                ...
                                <span><a href="binhnluu@gmail.com">binhnluu@gmail.com</a></span>
                            </li>
                        </ul>
                    </div>
                </div>
