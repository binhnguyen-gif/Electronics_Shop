                            ...
                            <div class="col-md-9">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" placeholder="Tên sliders" class="form-control"
                                           value="{{ isset($slider) ? data_get($slider, 'name') : '' }}">
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="file" name="img" class="form-control" required=""
                                           value="{{ isset($slider) ? data_get($slider, 'img') : '' }}">
                                    <!-- <div class="error" id="password_error"></div> -->
                                </div>
                                <div class="form-group">
                                    ...
                                    <select name="status" class="form-control">
                                        <option value="1"
                                                @if(isset($slider) && data_get($slider, 'status') == 1) selected @endif>
                                            Hoạt động
                                        </option>
                                        <option value="0"
                                                @if(isset($slider) && data_get($slider, 'status') == 0) selected @endif>
                                            Ngừng hoạt động
                                        </option>
